        ...
        if (response.isSuccessful) {
            response.body()?.let { appData ->
                ...
                repositoryProvider.apply {
                    ...
                    repositoryProvider.robotInfoKeyRepository.insertAll(appData.robotInfoKeyList)
                    repositoryProvider.robotInfoKeyStateRepository.insertAll(appData.robotInfoKeyStateList)
