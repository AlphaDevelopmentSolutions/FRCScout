...
internal class EventListRecyclerViewAdapter(private val eventList: MutableList<Event>, private val context: MainActivity) : RecyclerView.Adapter<EventListRecyclerViewAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int)
    {
        ...
        viewHolder.view.EventDateTextView.text = String.format("%s - %s", event.startTime?.toString(), event.endTime?.toString())
        ...
        viewHolder.view.ViewEventButton.setOnClickListener {
            ...
            KeyStore.getInstance(context).setPreference(Constants.SharedPrefKeys.SELECTED_EVENT_KEY, eventList[viewHolder.adapterPosition].id)
