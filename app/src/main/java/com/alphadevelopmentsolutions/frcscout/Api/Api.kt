        ...
        private val postData: HashMap<String, String>)
{
            ...
            )
    {
        ...
        {
            val eventTeamList: ArrayList<com.alphadevelopmentsolutions.frcscout.Classes.Tables.EventTeamList> = ArrayList()
        ...
        {
            val scoutCardInfos: ArrayList<com.alphadevelopmentsolutions.frcscout.Classes.Tables.ScoutCardInfo> = ArrayList()
        ...
        {
            val robotInfoList: ArrayList<com.alphadevelopmentsolutions.frcscout.Classes.Tables.RobotInfo> = ArrayList()
        ...
        {
            val robotMedia: ArrayList<com.alphadevelopmentsolutions.frcscout.Classes.Tables.RobotMedia> = ArrayList()
            ...
            )
    {
        ...
        class RobotInfo(
                private val context: MainActivity,
                robotInfo: com.alphadevelopmentsolutions.frcscout.Classes.Tables.RobotInfo) :
                Set(
                        context,
                        context.keyStore.getPreference(Constants.SharedPrefKeys.API_KEY_KEY, "").toString(),
                        object : HashMap<String, String>()
        ...
        class ScoutCardInfo(
                private val context: MainActivity,
                scoutCardInfo: com.alphadevelopmentsolutions.frcscout.Classes.Tables.ScoutCardInfo) :
                Set(
                        context,
                        context.keyStore.getPreference(Constants.SharedPrefKeys.API_KEY_KEY, "").toString(),
                        object : HashMap<String, String>()
        ...
        class RobotMedia(
                private val context: MainActivity,
                robotMedia: com.alphadevelopmentsolutions.frcscout.Classes.Tables.RobotMedia) :
                Set(
                        context,
                        context.keyStore.getPreference(Constants.SharedPrefKeys.API_KEY_KEY, "").toString(),
                        object : HashMap<String, String>()
        ...
        class ChecklistItemResult(
                private val context: MainActivity,
                checklistItemResult: com.alphadevelopmentsolutions.frcscout.Classes.Tables.ChecklistItemResult) :
                Set(
                        context,
                        context.keyStore.getPreference(Constants.SharedPrefKeys.API_KEY_KEY, "").toString(),
                        object : HashMap<String, String>()
